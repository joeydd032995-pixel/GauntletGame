...
export function buildGroundDetail({scene,heightFn,rng}){
  ...
  const grassMat=makeFoliageMaterial();grassMat.transparent=false;grassMat.side=THREE.DoubleSide;const bladeGeo=new THREE.PlaneGeometry(.13,.5,1,3);bladeGeo.translate(0,.25,0);
