...
export const makeBarkMaterial=()=>physicalSurface('bark',{base:0x694737,secondary:0x2c201a,seed:47,frequency:.12,roughness:.9,roughVariation:.08,normalStrength:4.1,repeat:2.8,normalScale:1.0});
export const makeFoliageMaterial=()=>physicalSurface('foliage',{base:0x477257,secondary:0x19392c,seed:73,frequency:.11,roughness:.78,roughVariation:.12,normalStrength:2.4,repeat:2,normalScale:.55,side:THREE.DoubleSide});
