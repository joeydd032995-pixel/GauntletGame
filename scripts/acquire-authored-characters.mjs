...
async function installPinnedQuaterniusDressed(){
  ...
  console.log(`Pinned Quaternius dressed tier ready: two textureless rigged fantasy outfits, three authored equipment pieces and ${ualCore.length+ualCombat.length} Gauntlet-relevant authored animations. Nude/base-body presentation is no longer an allowed default.`);
}
