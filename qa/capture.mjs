...
try{
  ...
  try{failureTelemetry=await page.evaluate(()=>({authored:JSON.parse(JSON.stringify(window.__GAUNTLET_AUTHORED_CHARACTERS__||null)),environment:JSON.parse(JSON.stringify(window.__GAUNTLET_HYBRID_ENVIRONMENT__||null)),mocap:window.__GAUNTLET_MOCAP__||null,metrics:window.__GAUNTLET_METRICS__||null}));}catch(snapshotError){errors.push(`failure telemetry: ${snapshotError.message}`);}
