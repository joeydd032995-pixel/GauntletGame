...
function auditAuthored(label,a,required,minUnique){
  ...
  if(a.visualAcceptanceEligible!==true)visualBlockers.push(`${label} source tier ${a.sourceTier||'unknown'} (${a.provider||'unknown'}) is scaffold-only and cannot receive final visual approval`);
